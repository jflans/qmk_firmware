...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
        KC_EQL,       KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_FN1,
        KC_TAB,       KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_LCBR,
        CTL_T(KC_ESC),KC_A,   KC_S,   KC_D,   KC_F,   KC_G,
        KC_LSPO,      KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_LBRC,
        KC_LALT,      KC_MUTE,KC_VOLD,KC_VOLU,KC_GRV,
                                                KC_LABK,      KC_HOME,
                                                              KC_END,
                                        KC_BSPC,SFT_T(KC_DEL),KC_MEH,
        // right hand
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS,KC_MRWD,KC_MPLY,KC_MFFD,KC_TRNS,
                                       RGB_MOD,KC_TRNS,
                                               KC_TRNS,
       ...
       KC_TRNS, KC_AMPR, KC_1,   KC_2,    KC_3,    KC_BSLS, KC_TRNS,
                         KC_TRNS,KC_DOT,  KC_0,    KC_EQL,  EPRM,
       RGB_TOG, RGB_SLD,
       KC_TRNS,
